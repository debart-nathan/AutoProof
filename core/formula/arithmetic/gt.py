"""Arithmetic greater-than formula."""
...
class Gt(Formula):
    """Represents arithmetic greater-than."""
    ...
    def __eq__(self, other) -> bool:
        return isinstance(other, Gt) and self.left == other.left and self.right == other.right

    def __hash__(self) -> int:
        return hash((self.left, self.right, 'gt'))
