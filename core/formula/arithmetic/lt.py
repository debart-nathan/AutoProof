"""Arithmetic less-than formula."""

from typing import Optional, Tuple, List
from ...interfaces.formula import Formula

class Lt(Formula):
    """Represents arithmetic less-than."""
    ...
    def __eq__(self, other) -> bool:
        return isinstance(other, Lt) and self.left == other.left and self.right == other.right

    def __hash__(self) -> int:
        return hash((self.left, self.right, 'lt'))
