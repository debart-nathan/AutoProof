"""Arithmetic greater-than-or-equal formula."""
...
class Ge(Formula):
    """Represents arithmetic greater-than-or-equal."""
    ...
    def __eq__(self, other) -> bool:
        return isinstance(other, Ge) and self.left == other.left and self.right == other.right

    def __hash__(self) -> int:
        return hash((self.left, self.right, 'ge'))
